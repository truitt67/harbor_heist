...
dataStoreBanner.AnchorPoint = Vector2.new(0.5, 0)
dataStoreBanner.Size = UDim2.new(0, IS_MOBILE and 280 or 360, 0, 56)
-- Desktop stacks below the raid-banner slot (top-center); mobile takes the
-- top-center slot itself since the raid banner sits top-right there.
dataStoreBanner.Position = IS_MOBILE and UDim2.new(0.5, 0, 0, SAFE_TOP + 6) or UDim2.new(0.5, 0, 0, SAFE_TOP + 48)
table.insert(safeTopConsumers, function()
	dataStoreBanner.Position = IS_MOBILE and UDim2.new(0.5, 0, 0, SAFE_TOP + 6) or UDim2.new(0.5, 0, 0, SAFE_TOP + 48)
end)
...
dataStoreBannerIcon.Position = UDim2.new(0, 14, 0, 11)
