...
local FUNCTION_NAMES = { "StoreFish", "SellAll", "LockAquarium", "BuyItem", "GetState", "SubmitCatchInput", "SellFish", "StoreSingleFish", "ClaimIncome", "SpawnBoat", "RequestCollection", "ClaimCollectionReward", "RequestToggleRaidOptIn", "GetRaidTargets", "RequestRaidAttempt", "SubmitRaidResult" }
